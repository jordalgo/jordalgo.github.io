  ...
  e.waitUntil(
    caches.open('jordanromedotcom').then(cache => {
      return cache.addAll([
        '/',
        '/index.html',
        'http://fonts.googleapis.com/css?family=Alegreya:400,900,700',
        'http://fonts.gstatic.com/s/alegreya/v7/F5BSMOSf_T8GT2wiqqpj3Ygp9Q8gbYrhqGlRav_IXfk.woff2',
        'http://fonts.gstatic.com/s/alegreya/v7/77GwhzeWPpmLIJUaM8KhxIgp9Q8gbYrhqGlRav_IXfk.woff2',
        'http://fonts.gstatic.com/s/alegreya/v7/4vRXIs1BEbKX6mQ7lGu1I3YhjbSpvc47ee6xR_80Hnw.woff2',
