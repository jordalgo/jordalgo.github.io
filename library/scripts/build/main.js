...
var adjustPaddingBottom = _interopRequire(require("./adjust-padding-bottom"));

var loadWork = _interopRequire(require("./load-work"));

var highlightNav = _interopRequire(require("./highlight-nav"));

module.exports = function () {
  var userScrolled = false, resize = {};

  $("a[href*=#]").click(function (e) {
    var location = window.location, target = e.target.nodeName === "SPAN" ? e.target.parentElement : e.target;
...
},{"./adjust-padding-bottom":1,"./highlight-nav":4,"./load-work":5,"jQuery":"HvFl7m"}],3:[function(require,module,exports){
"use strict";
...
var setEventListeners = _interopRequire(require("./event-listeners"));
...
$(document).ready(function () {
  var WINDOW_WIDTH = $(window).width(), elWorkContainer = document.querySelector(".work-site-container"), elContact = document.querySelector(".contact");
...
},{"./adjust-padding-bottom":1,"./event-listeners":2,"./load-work":5,"jQuery":"HvFl7m"}],4:[function(require,module,exports){
"use strict";

var $ = require("jQuery");

var WINDOW_HEIGHT = window.innerHeight, $COVER_IMAGE = $(".cover-image"), $ABOUT = $(".about-me"), $WORK = $(".work"), $CONTACT = $(".contact"), $TAGLINE = $(".tagline");

var WINDOW_POS = $(window).scrollTop(), COVER_IMAGE_HEIGHT = $COVER_IMAGE.height(), TOP2_HEIGHT = COVER_IMAGE_HEIGHT + $ABOUT.height(), TOP3_HEIGHT = TOP2_HEIGHT + $WORK.height();
...
exports.highlightNav = highlightNav;
exports.reCalculateHeights = reCalculateHeights;
},{"jQuery":"HvFl7m"}],5:[function(require,module,exports){
"use strict";
...
var WORK_DATA = _interopRequire(require("./work"));
...
module.exports = function (el) {
  ...
  WORK_DATA.forEach(function (work) {
...
},{"../templates/work.hbs":7,"./highlight-nav":4,"./work":6}],6:[function(require,module,exports){
"use strict";
...
module.exports = [{
  ...
  details: "Designed and coded by yours truly. This site is built in static php and incorporates custom jQuery slideshows, subscribe/unsubscribe forms, and the latest in css. Now updated and run completely by the site's founder, Anne Hays.",
  link: {
  ...
  description: "Valam offers the FOX Laser System, an infrared diode surgical laser cleared for general surgical indications. The FOX Laser System's small size, low price and versatility make it perfectly suited for office-based surgical procedures.",
  details: "Currently under construction, this new Valam website will be built using Wordpress and will be fully responsive. Displaying the latest in web technology, employing accsesibility standards and SEO, this site will make it's mark.",
  link: {
  ...
  description: "Dr. Krespi is an authority on management of oral malodor also known as halitosis and management of chronic rhino sinusitis.",
  details: "Built using Wordpress for easy updates by the client and incorporating all types of multi-media and social media integration, this site is inuitive and easy on the eyes. A great resource for anyone who is looking to prevent or treat Halitosis.",
  link: {
  ...
  description: "A full-service law firm that puts the client's interests first and includes representation on a contingent-fee basis where appropriate.",
  details: "Built using Wordpress for easy updates by the client and incorporating php contact forms, this site is simple and clean. A perfect example of how your web presence doesn't have to be overly complicated and cluttered to lead people to your business.",
  link: {
  ...
  description: "Education and college admissions counselor. In her private practice, all of her students have been admitted to college and many have entered prestigious institutions such as Harvard, Dartmouth, UCLA, Berkeley, and Penn. Yes, this is my mom's website.",
  details: "Designed and built by Jordan Rome, this is a static html website that I update and has been a great resource for Melanie in terms of bringing on new clients.",
  link: {
  ...
  description: "Helaina is a change agent who helps you investigate and tackle whatever is cluttering your life. Through a series of conversations and exercises you will discover what created the mess.",
  details: "HTML/CSS statically coded website, employing semantic markup and web standards.",
  link: {
  ...
  description: "A family therapist practicing in Los Angeles, California.",
  details: "Designed and built by Jordan Rome.",
  link: {
  ...
  description: "PIQUE Learning gives children of all levels the tools they need for optimal learning to take place, namely: reading, independent thinking, problem solving and organizational skills.",
  details: "Designed by Jordan Rome and built using Wordpress for easy updates by the client and incorporating all types of multi-media and social media integration, this site is inuitive and employs SEO and web accesibilty standards.",
  link: {
  ...
  description: "Personal chef, Marina Berger is a personal chef and caterer.",
  details: "Designed and coded by Jordan Rome. This site was built years ago and incorporated a javascript slideshow and a wordpress blog; it has since been altered by Marina but still carries some of the themes of the original design.",
  link: {
...
},{"./dist/cjs/handlebars.runtime":10}]},{},[3])