...
$replyemail="jordan@jordanrome.com";//change to your email address
$valid_ref1="http://www.jordanrome.com";// chamge "Your--domain" to your domain
$valid_ref2="http://www.jordanrome.com";// chamge "Your--domain" to your domain
...
$ref_page= 'http://www.jordanrome.com';
$valid_referrer=0;
...
function is_forbidden($str,$check_all_patterns = true)
{
 ...
 $patterns[1] = '/mime-version/i';
 $patterns[2] = '/multipart\/mixed/i';
 $patterns[3] = '/Content-Transfer-Encoding/i';
 $patterns[4] = '/to:/i';
 $patterns[5] = '/cc:/i';
 $patterns[6] = '/bcc:/i';
 $patterns[7] = '/http:/i';
...
$headers = 'From: Jordan Rome <jordan@jordanrome.com>' . "\r\n" .
    'Reply-To: jordan@jordanrome.com' . "\r\n" .
...
header("Location: http://www.jordanrome.com/index.html");
